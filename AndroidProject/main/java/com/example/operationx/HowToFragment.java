...
public class HowToFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView howToText = view.findViewById(R.id.howToInstructions);
        int level = getArguments().getInt("LEVEL_HOW", 1);
        if(level == 1){
            howToText.setText(R.string.level_one_howTo);
        }else if(level == 2){
            howToText.setText(R.string.level_two_howTo);
        }
