...
class Staging_Parts_Window:
    ...
    def load_product_info(self):
        ...
        self.product_info_enter_quantity.insert(0, '1')
        self.product_info_enter_quantity.pack(side='left', anchor='w',pady=4, padx=10)
        self.product_info_enter_quantity.bind('<Return>', self.stage_part)
        self.product_info_enter_quantity.configure(state='disabled')

        short_cut_frame = customtkinter.CTkFrame(product_info_frame)
        ...
        customtkinter.CTkLabel(short_cut_frame, text="F5. Quantity", font=("Roboto", 20)).pack(side='left', anchor = 'w', pady=1, padx=10)        
    ...
    def load_staging_view(self):
        ...
        customtkinter.CTkLabel(staging_view_frame, text="Staging View", font=("Roboto", 40)).pack(side = 'top', pady=2, padx=10)
